...
type Action<T> = { type: 'loading' } | { type: 'done'; payload: T } | { type: 'error'; payload: Error };

export function useFetch<T = unknown>(url?: string, options?: any, executeOnMount = true): State<T> {
